...
This project originated from a job interview where I was asked to design a rocket and simulate it's max hypothetical range. The writeup that proceeds outlines the general approach I took to solving the problem and simulating the rocket in the [Elodin](https://www.elodin.systems) environment. The [repository can be found here](https://github.com/rq-d/MissileSim/tree/prompt): 

<ImageGrid
  columns={1}
  rows={1}
  images={[
    { src: "/photos/missile.PNG", alt: "Photo2" },
  ]}
/>
### Development Path
...
<ImageGrid
  columns={1}
  images={[
    { src: "/photos/figure_1.png", alt: "Photo2" },    
  ]}
/>
